...
activities = Activity.create([{name: 'Idle', description: 'This unit is not currently doing anything.', effects: {hp: 10, sp: 10}, location_id: nil, category: 'open'},
								...
								{name: 'Forge iron sword', description: 'Use iron to create a sword.', effects: {inventory: '-5_iron 1_sword'},location_id: nil, category: 'crafting'},
								{name: 'Alchemy potion', description: 'Use herbs to create a potion.', effects: {inventory: '-5_herb 1_potion'}, location_id: nil, category: 'crafting'},
								{name: 'Process rabbit', description: 'Process a dead rabbit into meat and leather.', effects: {inventory: '-1_rabbit(dead) 1_meat 1_leather'}, location_id: nil, category: 'crafting'},
								{name: 'Process snake', description: 'Process a dead snake into meat and leather.', effects: {inventory: '-1_snake(dead) 1_meat 1_leather'}, location_id: nil, category: 'crafting'},
								{name: 'Cook stew', description: 'Cooks meat into stew.', effects: {inventory: '-5_meat 1_stew'}, location_id: nil, category: 'crafting'},
