...
activities = Activity.create([{name: 'Idle', description: 'This unit is not currently doing anything.', effects: {hp: 10, sp: 10}, location_id: nil, category: 'open'},
								...
								{name: 'Forge iron sword', description: 'Use iron to create a sword.', effects: {inventory1: '-5_iron 1_sword', sp: -20},location_id: nil, category: 'crafting'},
...
hall_inventories = HallInventory.create([{guild_hall_id: 2, item_id: 1, available: 100, total: 600, selling: 500, using: 0}])
